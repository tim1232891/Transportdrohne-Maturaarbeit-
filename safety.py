...
# ist das Sicherheitsprogramm für die Batterie
async def battery(the_connection, queue_safety):
    while True:
        ...
        if battery_percentage < 35: #Warnung wird gesendet, damit Pilot:in bescheid bekommt.
            print("\033[91mBATTERIE WARNUNG:\033[0m Die Landung wird in kürze eingeleitet!!")

        if battery_percentage < 30: # sofortige Landung wird eingeleitet. Es wird auch kein execution programm 
            #berücksichtig, da es völlig unabhängig läuft
